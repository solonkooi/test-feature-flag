...
import featureFlagClient.generated.FeatureFlagService_pb2 as FeatureFlagService__pb2
...
class FeatureFlagServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetFeatureFlag = channel.unary_unary(
        '/videa.featureflag.services.types.FeatureFlagService/GetFeatureFlag',
    ...
    self.SetFeatureFlag = channel.unary_unary(
        '/videa.featureflag.services.types.FeatureFlagService/SetFeatureFlag',
    ...
    self.DeleteFeatureFlag = channel.unary_unary(
        '/videa.featureflag.services.types.FeatureFlagService/DeleteFeatureFlag',
    ...
    self.SetFeatureFlagForStations = channel.unary_unary(
        '/videa.featureflag.services.types.FeatureFlagService/SetFeatureFlagForStations',
    ...
    self.IsFeatureFlagEnabledForStations = channel.unary_unary(
        '/videa.featureflag.services.types.FeatureFlagService/IsFeatureFlagEnabledForStations',
...
def add_FeatureFlagServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'videa.featureflag.services.types.FeatureFlagService', rpc_method_handlers)
